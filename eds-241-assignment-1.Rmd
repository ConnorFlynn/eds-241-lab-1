...
B). Tulare has the highest level of poverty in California
...
D). Estimated Slope Coefficient = 0.1179
    ...
    For every one unit increase in PM2.5 concentration, there is a 0.1179% increase in low birth weights
...
F). For every one unit increase in poverty, there is a 0.02 % increase in low birth weights.
    The estimated coefficient on PM2.5 decreases compared to the regression excluding poverty as an explanatory variable. This      makes sense because we've added an explanatory variable that effects the percentage of low birth weights, therefore decreasing the significance of PM2.5 in the regression. 
    

G). The absolute value of the test statistic is greter than 2, therefore rejecting the null hypothesis that the effect of PM2.5 is equal to the effect of Poverty 
...
birth_weight_PM2.5_plot = ggplot(data = data, aes(x = PM2.5, 
                                                  y = Low.Birth.Weight, col = California.County)) +
  geom_point()+
